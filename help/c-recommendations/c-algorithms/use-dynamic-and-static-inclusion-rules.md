...
| サブ文字列<br>が含まれます(エンティティ属性の一致、プロファイル属性の一致、パラメーターの一致および静的フィルターで使用可能)。 | 「サブ文字列を含む」演算子を使用して、訪問者がWebサイト上のアイテム（製品など）を表示している場合、次のような他のアイテムをプロモーションできます。<ul><li></li></ul> |  |
| Does Not Contain Substring<br>(エンティティ属性の一致、プロファイル属性の一致、パラメーターの一致および静的フィルターで使用可能) | 訪問者がWebサイト上のアイテム（製品など）を表示しているときに、「does not contain substring」演算子を使用して、次のような他のアイテムをプロモーションできます。<ul><li></li></ul> |
| <br>を持つ開始(エンティティ属性の一致、プロファイル属性の一致、パラメーターの一致、静的フィルターで使用可能) | 「開始と」演算子を使用して、訪問者がWebサイト上のアイテム（製品など）を表示している場合、次のような他のアイテムをプロモーションできます。<ul><li></li></ul> |
| <br>で終わる(エンティティ属性の一致、プロファイル属性の一致、パラメーターの一致、静的フィルターで使用可能) | 「次の語句で終わる」演算子を使用して、訪問者がWebサイト上の項目（製品など）を表示している場合、次のようなその他の項目をプロモーションできます。<ul><li></li></ul> |
...
| リスト<br>に含まれる(プロファイル属性の一致とパラメータの一致で使用可能)。 | プロファイル属性の一致で「リストに含まれる」演算子を使用して、訪問者がWebサイト上のアイテム（製品、記事、ムービーなど）を表示している場合、次のような他のアイテムをプロモーションできます。<ul><li>訪問者の地域で利用可能</li></ul>この演算子を使用する場合、ルールの[右側](#caveats)にリストが必要です。 |
| はリスト<br>に含まれていません(プロファイル属性の一致とパラメータの一致で使用可能)。 | プロファイル属性の一致で「リストに含まれない」演算子を使用して、訪問者がWebサイト上のアイテム（製品、記事、ムービーなど）を表示している場合、以下の他のアイテムを除外できます。<ul><li>訪問者が最近閲覧した10品目のリスト</li></ul></ul>この演算子を使用する場合、ルールの[右側](#caveats)にリストが必要です。 |
| リストには、<br>(エンティティ属性の一致、プロファイル属性の一致、パラメータの一致で使用可能)内の項目が含まれます。 | プロファイル属性の一致で「リストに含まれるアイテム」演算子を使用すると、訪問者がWebサイト上のアイテム（製品、記事、ムービーなど）を表示している場合、次のアイテムをレコメンデーションできます。<ul><li>訪問者のお気に入りのチームの1つに関連付けられています</li></ul></ul>この演算子を使用する場合、ルールの[両側](#caveats)にリストが必要です。 |
| リストに<br>に項目が含まれていません(エンティティ属性の一致、プロファイル属性の一致、パラメーターの一致で使用可能)。 | 訪問者がWebサイト上のアイテム（製品、記事、ムービーなど）を表示しているときに、パラメーター属性の一致で「リストーにアイテムが含まれません」演算子を使用すると、次のような他のアイテムを除外できます。<ul><li>禁止型のリストに含まれる</li></ul>この演算子を使用する場合、ルールの[両側](#caveats)にリストが必要です。 |
| リストには、<br>(エンティティ属性の一致、プロファイル属性の一致、パラメータの一致で使用可能)内のすべての項目が含まれます。 | 訪問者がWebサイト上のアイテム(リスト、記事、ムービーなど)を表示している場合、パラメーター属性の一致で「製品に含まれるすべてのアイテム」演算子を使用して、次のアイテムをプロモーションできます。<ul><li></li></ul>この演算子を使用する場合、ルールの[両側](#caveats)にリストが必要です。 |
| <br>(エンティティ属性の一致、プロファイル属性の一致、パラメータの一致で使用可能)内のすべての項目がリストに含まれていません。 | 訪問者がWebサイト上のアイテム(リスト、記事、ムービーなど)を表示しているときに、パラメーター属性の一致で「製品に含まれないアイテム」演算子を使用すると、次のアイテムをプロモーションできます。<ul><li></li></ul>この演算子を使用する場合、ルールの[両側](#caveats)にリストが必要です。 |
