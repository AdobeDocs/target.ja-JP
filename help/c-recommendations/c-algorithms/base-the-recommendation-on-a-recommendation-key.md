...
description: 訪問者の動作コンテキストを使用するキーに基づいて、Adobe [!DNL Target] Recommendationsアクティビティで関連する結果を表示するレコメンデーションの使用方法を説明します。
...
このロジックを使用すると、商品を表示した他の訪問者が購入した品目を表示する商品など、商品ページにレコメンデーションを表示して、クロス販売機会を増やすことができます。 例えば、訪問者が釣り竿を見ている場合、タックルボックス、ワッダー、釣り用ポアなど、他に購入した訪問者が表示されることがあります。 訪問者がサイトを閲覧する際に、追加の購入レコメンデーションを提供します。
