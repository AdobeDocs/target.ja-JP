...
>[!NOTE]
>
>最近表示された項目は、アクティビティの除外グローバル設定と選択されたコレクション設定の両方を考慮します。項目は、グローバル除外によって除外されたり、選択されたコレクションに含まれていない場合、表示されません。したがって、最近表示された項目条件を使用する場合、通常、「すべてのコレクション」設定を使用する必要があります。
...
サイトで最も多く閲覧された品目を表示します。

このロジックを使用すると、サイトで最も閲覧された品目に基づいてレコメンデーションを表示し、他の品目のコンバージョンを増やすことができます。 例えば、メディアサイトでは、最も人気のあるビデオに関するレコメンデーションをホームページに表示して、訪問者に追加のビデオを見るよう促すことができます。
...
他の訪問者が選択した品目を購入した人が購入した品目を表示します。

このロジックを使用すると、他の購入者が購入した品目を表示するなど、買い物かごサマリページにレコメンデーションを表示して、クロス販売機会を増やすことができます。 例えば、訪問者がスーツを購入する場合、レコメンデーションでは、ネクタイ、ドレスシューズ、カッフリンクなど、他の訪問者が購入した追加の品目を表示できます。 訪問者が購入を確認する際、追加の購入推奨事項を提示します。
...
選択した品目を閲覧した訪問者が購入した他の品目を表示します。

このロジックを使用すると、商品を表示した他の訪問者が購入した品目を表示する商品など、商品ページにレコメンデーションを表示して、クロス販売機会を増やすことができます。 例えば、訪問者が釣り竿を見ている場合、タックルボックス、ワダー、釣り道具など、購入した商品を見ている他の訪問者にも、レコメンデーションで表示できます。 訪問者がサイトを閲覧する際に、追加の購入レコメンデーションを提供します。
...
他の訪問者が、選択した品目を閲覧した人にも表示した品目を表示します。

このロジックを使用すると、ある品目を閲覧した他の訪問者も閲覧した品目をレコメンデーションすることで、追加のコンバージョン機会を作成できます。 例えば、サイトで表示ロードバイクを利用している訪問者は、バイクのヘルメット、サイクリングキット、ロックなども閲覧できます。 他の製品を提案するこのロジックを使用して、レコメンデーションを作成できます。
...
Adobe独自のアルゴリズムを使用して品目を表示し、商品ページの表示、購入、買い物かごのアクティビティ（商品の追加と削除、買い物かごの表示など）などの基準に基づいて他の品目をレコメンデーションします。

例えば、オンライン小売業者は、過去のセッションで訪問者がその後の訪問で興味を示した品目をレコメンデーションできます。 各訪問者のセッションのアクティビティをキャプチャし、最新性と頻度のモデルに基づいてアフィニティスコアを計算します。 この訪問者がサイトに戻ると、サイトのアフィニティは、サイト上で過去に行われたアクションに基づいてレコメンデーションを表示するのに使用されます。
...
訪問者のコンバージョンに基づいて、サイトでトップセル商品を表示します。

このロジックを使用すると、サイトで人気のある品目のレコメンデーションを作成して、コンバージョンを増やすことができます。 このロジックは、サイトへの初回訪問者に特に適しています。
