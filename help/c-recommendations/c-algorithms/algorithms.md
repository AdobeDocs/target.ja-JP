...
seo-description: Adobe targetの条件は、事前に決められた訪問者の行動に基づいて、どの商品をレコメンデーションするかを決定するルールです。
seo-title: 条件
solution: 'Target '
title: 条件
...
![条件カードのカーソルを合わせる](/help/c-recommendations/c-algorithms/assets/criteria_hover.png)
