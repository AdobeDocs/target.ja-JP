...
* 事前定義されたエンティティの属性名はカスタムエンティティの属性に使用できません。[（エンティティの属性を](../../c-recommendations/c-products/entity-attributes.md#reference_3BCC1383FB3F44F4A2120BB36270387F)参照）。
...
Delivery APIおよびSave entities APIの使用について詳しくは、 [Adobe Recommendations APIのドキュメント](http://developers.adobetarget.com/api/recommendations) を参照してください。
...
次の例では、ルールは「`message contains abc`.
