...
* 最高のパフォーマンスを得るための推奨制限は、カタログを環境ごとに100万個未満、すべての環境で1,000万個未満にすることです。
* 上限は、1環境あたり1,000万個の項目と、すべての環境で1,000万個の項目です。 環境あたり100万～1000万個の項目がある場合は、[!UICONTROL カタログ検索] UIのパフォーマンスに影響します。 [!DNL Target Recommendations]ただし、は引き続きレコメンデーションの生成と配信をおこないます。
