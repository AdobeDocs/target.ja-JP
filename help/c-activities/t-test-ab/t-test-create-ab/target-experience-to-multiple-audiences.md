...
# A/B テストの複数のエクスペリエンスバージョン{#multiple-experience-versions-in-an-a-b-test}
...
1. [通常通りに A/B アクティビティを作成](../../../c-activities/t-test-ab/t-test-create-ab/test-create-ab.md#task_68C8079BF9FF4625A3BD6680D554BB72)します。
   ...
   複数のバージョンを持つエクスペリエンスを設定する際に、次の手順のようにして各バージョンのオーディエンスを選択します。1. エクスペリエンスを選択し、 **[!UICONTROL 設定]** / **[!UICONTROL オーディエンス]** / **[!UICONTROL 複数のオーディエンス]**をクリックします。
