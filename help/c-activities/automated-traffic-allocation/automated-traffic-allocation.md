...
### Target用Analytics(A4T)は自動配分アクティビティをサポートしていますか。

はい。詳しくは、 [Analyticsを参照して、](/help/c-integrating-target-with-mac/a4t/campaign-creation.md#a4t-aa) アクティビティ作成時の自動配分アクティビティのTarget(A4T)サポートを確認してください **。
