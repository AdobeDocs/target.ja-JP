...
>[!NOTE]
>
>アクティビティに2つのエクスペリエンスのみが含まれる場合、[!DNL Target]が信頼性75%の勝者エクスペリエンスを見つけるまで、両方のエクスペリエンスのトラフィックが均等になります。 その時点で、トラフィックの2/3が勝者に、1/3が敗者に割り当てられます。 その後、エクスペリエンスが95%の信頼性に達すると、トラフィックの90%が勝者に、10%が敗者に配分されます。 長期的に誤検出を避ける（つまり、調査の維持）ために、常に「失敗」エクスペリエンスに送信されるトラフィックを維持します。
