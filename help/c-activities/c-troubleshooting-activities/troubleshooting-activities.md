...
description: Adobe [!DNL Target] アクティビティがサイトに表示されない場合は、トラブルシューティングの提案を見つけてください。
...
[!DNL Adobe Target]アクティビティがサイトに表示されない場合は、これらのトラブルシューティングの提案が解決に役立ちます。
...
## [!DNL Target] UIを使ってアクティビティを作成しましたが、APIを使って更新することはできません。
...
## [!DNL Target] APIを使用してアクティビティをアクティブ化しましたが、アクティビティは[!DNL Target] UIに[!UICONTROL 非アクティブ]のステータスを表示します。
