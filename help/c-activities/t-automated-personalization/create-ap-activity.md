...
1. （条件付き）「**[!UICONTROL オファー]**」をクリックして、コンテンツを選択してレポートグループに割り当てたり、ターゲット設定によって特定のオファーの閲覧を特定の訪問者のみに許可したりします。
   ...
   詳しくは、「[自動パーソナライゼーションのオファーレポートグループ](../../c-reports/offer-reporting-groups-in-automated-personalization.md#concept_194128C0B56B4B26AAB57DB49892960C)」を参照してください。
...
1. （条件付き）[!UICONTROL コントロール]ドロップダウンリストから、[コントロールとして使用する特定のエクスペリエンスを選択](/help/c-activities/t-automated-personalization/experience-as-control.md)するか、[!UICONTROL ランダムエクスペリエンス]を選択します。
...
詳しくは、「[自動パーソナライゼーションレポート](../../c-reports/reports-ap.md#concept_C02BAFC922114A44846998FD956E345A)」を参照してください。
