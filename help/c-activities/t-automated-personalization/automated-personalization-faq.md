...
* トラフィックが少ないページのパーソナライゼーションをおこなう場合や、パーソナライゼーションをおこなうエクスペリエンスに構造的な変更を加える場合は、自動パーソナライゼーションの代わりに、自動ターゲットを使用することをお勧めします。詳しくは、 [自動ターゲットを参照してください](/help/c-activities/auto-target-to-optimize.md)。
