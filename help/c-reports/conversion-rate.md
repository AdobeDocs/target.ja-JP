---
keywords: ターゲット設定
description: Adobe [!DNL Target] が、各エクスペリエンスのコンバージョン率、上昇率、信頼性（統計の有意性）および信頼区間を表示し、計算する方法を説明します。
...
## なぜ[!DNL Target]がスチューデントのt検定を使うことを推奨するのですか？{#t-test}
