...
[!UICONTROL アクティビティでパーソナライゼーションインサイト] レポートがまだ利用できない理由はいくつかあります。
...
* 指定した期間中、アクティビティに十分なトラフィックがありませんでした。パーソナライゼーションモデルを作成するための [十分なパーソナライズされたトラフィック](/help/c-activities/auto-target-to-optimize.md#section_BA4D83BE40F14A96BE7CBC7C7CF2A8FB) がアクティビティにあるとしても、パーソナライゼーションモデル、自動セグメントおよび重要属性レポートを作成することができます。
