...
1. **データセットを追加** ダイアログで、選択したデータセット ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-connections/create-connection#dataset-settings)ごとに[設定を設定します。
