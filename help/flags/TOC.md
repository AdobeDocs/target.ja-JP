...
+ オーディエンス基準 {#audience}
  ...
  + [コンテキスト属性の作成](guides/audience/creating-your-context-attributes.md)
  + [ルールセットの作成と使用](guides/audience/creating-and-using-rule-sets.md)
+ 機能フラグの読み込み {#import}
...
+ 統合ガイド {#sdk-releases}
  ...
  + [web拡張機能の統合ガイド](guides/sdk-releases/web/web-extension-integration-guide.md)
