...
description: Analytics for [!DNL Target] (A4T)を使用して、Analyticsのコンバージョン指標とオーディエンスセグメントに基づいてアクティビティを作成し、Analyticsレポートを使用して結果を調べます。
title: Analytics for [!DNL Target] (A4T)とは
...
# Adobe[!DNL Target]のレポート源としてのAdobe Analytics(A4T)
