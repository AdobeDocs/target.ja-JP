...
* **[!UICONTROL 監視者]**: 表示アクティビティは作成できますが、作成または編集はできません。
* **[!UICONTROL エディタ]**: アクティビティの作成および編集は、アクティビティの起動前に行うことはできますが、承認を行うことはできません。
* **[!UICONTROL 承認者]**: アクティビティを作成、編集、アクティブ化または停止できます。
