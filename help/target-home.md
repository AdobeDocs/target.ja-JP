...
**最終更新日：2020年3月30日([変更点を参照](r-release-notes/doc-change.md))**

>[!IMPORTANT]
>
>Adobe Summitが仮想イベント アドビは、ライブのデジタルエクスペリエンスを活用して、すべての停止を引き出しています。 このライブエクスペリエンスには、主要段階の基調講演、最新のトレンドと進歩を取り上げたミニキーノート、業界リーダーの成功に対する洞察、および分類セッションが含まれます。 デジタルイベント全体に無料でアクセスできるように登録するには、Digital Experience Conference [にアクセスします。サミット](https://www.adobe.com/summit.html) ページ
