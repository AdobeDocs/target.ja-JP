...
**最終更新日：2020年3月13日([変更点を参照](r-release-notes/doc-change.md))**

>[!IMPORTANT]
>
>Adobe Summitは仮想イベントになりました。 アドビは、ライブのデジタルエクスペリエンスを活用して、すべての停止を引き出しています。 このライブエクスペリエンスには、主要段階の基調講演、最新のトレンドと進歩を取り上げたミニキーノート、業界リーダーの成功に対する洞察、および分類セッションが含まれます。 デジタルイベント全体への無料アクセスを登録するには、Digital Experience Conference [にアクセスします。サミット](https://www.adobe.com/summit.html) ページ
...
- [Adobe Targetチュートリアル](https://docs.adobe.com/content/help/en/target-learn/tutorials/overview.html):Targetを最大限に活用するためのチュートリアルとビデオを提供します。
...
- [Target Server-Side API](https://developers.adobetarget.com/api/delivery-api/):Adobe Target Delivery APIを構成するリソースについて説明します。
- [Target NodeJS SDK](https://github.com/adobe/target-nodejs-sdk):Targetサーバー側のデプロイ方法を説明します。 このNode.js SDKを使用すると、Targetを他のAdobe Experience Cloudソリューションと簡単に統合できます。
- [Target Java SDK](https://github.com/adobe/target-java-sdk):Targetサーバー側のデプロイ方法を説明します。 このJava SDKを使用すると、Targetを他のAdobe Experience Cloudソリューションと簡単に統合できます。
- [Target Recommendations API](https://developers.adobetarget.com/api/recommendations/):公式のAdobe Target Recommendations APIを構成するリソースについて説明します。
- [Target Adobe.IOドキュメント](http://developers.adobetarget.com/api/#introduction):Adobe.IO統合を使用するTargetの管理APIとプロファイルREST APIを使用して、アクティビティ、オーディエンス、オファー、プロパティ、レポート、mbox、環境およびプロファイルを管理する方法について説明します。
