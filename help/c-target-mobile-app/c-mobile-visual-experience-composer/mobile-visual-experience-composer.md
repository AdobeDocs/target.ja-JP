...
新しいアプリバージョンが検出されると、アプリバージョンがターゲットバージョンのリストに追加されたことが通知されます。

![新しいアプリ通知](/help/c-target-mobile-app/c-mobile-visual-experience-composer/assets/manage-versions-notification-new.png)

[!UICONTROL バージョンを管理]ダイアログボックスから、複数のモバイルアプリバージョンを手動で追加および削除できます。

![バージョンを管理ダイアログボックス](/help/c-target-mobile-app/c-mobile-visual-experience-composer/assets/manage-versions-dialog.png)
...
## トレーニングビデオ：Adobe Target モバイルアプリ Visual Experience Composer（3：33） {#video}
