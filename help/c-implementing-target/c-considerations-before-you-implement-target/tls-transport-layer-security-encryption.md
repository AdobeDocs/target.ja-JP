...
## 1.2未満のTLSバージョンをサポートするブラウザーでの予期された動作 {#section_B5DA97A34EF248EB927610A5DA71EF2F}

この節では、at.jsまたはmbox.js実装を使用する場合にのみ、1.2より前のTLSバージョンをサポートするブラウザーでの期待値について説明します。 比較のため、この節では、TLS 1.2をサポートするブラウザーでの期待値についても説明します。
