...
| プロファイルおよびオーディエンス（P&amp;A） | 『 [コアサービスユーザガイド](https://experienceleague.adobe.com/docs/core-services/interface/audiences/audience-library.html) 』の *オーディエンスを参照してください*。 |
