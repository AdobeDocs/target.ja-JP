...
詳しくは、「Adobe Targetのat.js 2.xをシングルページアプリ(SPA)に [実装する](https://helpx.adobe.com/target/kt/using/atjs2-single-page-application-technical-video-implement.html) 」を参照してください。
