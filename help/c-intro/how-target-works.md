...
必要に応じて、[!DNL Target] のエッジクラスターを許可リストに追加できます。詳しくは、[Target のエッジノードを許可リストに登録する](/help/c-implementing-target/c-considerations-before-you-implement-target/allowlist-edges.md)を参照してください。
