...
| 落とし穴 | 解決策 |
| --- | --- |
| 統計的に有意な結果に達するのに十分なトラフィックがない。 | Adobe Targetの [サンプルサイズ計算ツールを使用して](https://docs.adobe.com/content/target-microsite/testcalculator.html) 、テストを実行してからテストを完了するまでの期間を事前に確認しておきます。 |
