...
次のビデオでは、Target を他の Adobe Experience Cloud ソリューションと共に組織の目標達成に役立てる方法に関する基礎知識を提供します。
...
[レコメンデーションとしてレコメンデーション](/help/c-recommendations/recommendations-as-an-offer.md) を使用すると、 [!UICONTROL A/Bテスト] （ [!UICONTROL 自動配分] および [!UICONTROL 自動ターゲット]を含む）および [!UICONTROL エクスペリエンスターゲット設定] （XT）アクティビティ内にレコメンデーションを含めることができます。
