...
オファー、画像、テキスト、ボタン、ビデオ、ページ全体のこれらのさまざまな要素の組み合わせ、Webページ全体、またはおそらく購入ファネルやその他のページの論理的なシーケンスを形成する一連のページ。また、音声アシスタントや顧客サービススクリプト、または飲み物マシンからのパーソナライズされたフレーバーに対応することもできます。アクティビティの [!DNL Target] エクスペリエンスをテストまたはパーソナライズできます。
