---
description: Adobe Targetでオーディエンスを作成して、特定のブラウザーまたは特定のブラウザーオプションを使用してページを訪問したユーザーをターゲットにすることができます。
keywords: ブラウザーオプション;タイプ;ブラウザータイプ;ブラウザー言語;言語;バージョン;ブラウザーバージョン
seo-description: Adobe Targetでオーディエンスを作成して、特定のブラウザーまたは特定のブラウザーオプションを使用してページを訪問したユーザーをターゲットにすることができます。
seo-title: Adobe Targetオーディエンスのブラウザーオプション
solution: 'Target '
subtopic: 多変量分析テスト
title: ブラウザー
topic: Premium
...
![Target IE10および11](/help/c-target/c-audiences/c-target-rules/assets/target_ie-10-11.png)
...
例えば、オファーが英語でのみ利用可能な場合、言語が英語に設定されたブラウザーをターゲットにすることができます。または、ページで全角文字が無効な場合、東アジア言語に設定されたブラウザーを除外することがあります。
