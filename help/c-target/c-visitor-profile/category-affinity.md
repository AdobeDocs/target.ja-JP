...
プロファイルスクリプト `user.categoryAffinities[]` では、訪問者が入力した親和性の配列を返すことができます。詳しくは、 [「オブジェクト」の下の user.categoryAffinities と「プロファイル属性」のメソッド](/help/c-target/c-visitor-profile/profile-parameters.md#objects).
