...
description: カテゴリ親和性のAdobe [!DNL Target] これは、ユーザーが訪問するカテゴリを自動的にキャプチャし、ターゲット設定とセグメント化をおこなえるように、カテゴリに対するユーザーの親和性を計算します。
title: カテゴリ親和性とは
feature: Audiences
...
のカテゴリ親和性機能 [!DNL Adobe Target] は、ユーザーが訪問するカテゴリを自動的にキャプチャし、ターゲット設定とセグメント化をおこなえるように、カテゴリに対するユーザーの親和性を計算します。 カテゴリ親和性は、その情報に基づいて行動する可能性が最も高い訪問者をコンテンツのターゲットにするのに役立ちます。
