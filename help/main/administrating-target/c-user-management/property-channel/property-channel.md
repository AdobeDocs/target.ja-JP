...
* 次の管理者の任意の設定割り当てページは、任意のワークスペースの承認者が制御できます。
...
>[!NOTE]
>
>オーディエンスを編集するには、適切な権限が必要です。 また、オーディエンスを他のアクティビティで使用しないでください。 オーディエンスが他のアクティビティで使用されていて、オーディエンスを別のワークステーションに移動する場合は、オーディエンスが使用されている他のアクティビティからオーディエンスを削除します。
