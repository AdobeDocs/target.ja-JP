...
description: Analytics for [!DNL Target]  （A4T）の使用方法を説明します。 A4T統合では、Adobe [!DNL Target]  アクティビティに関する堅牢なAdobe Analytics レポートにアクセスできます。
title: ' [!DNL Target]  （A4T） レポートにAnalyticsを使用するにはどうすればよいですか？'
