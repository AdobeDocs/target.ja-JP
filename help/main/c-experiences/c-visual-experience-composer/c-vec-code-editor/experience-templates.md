...
次に関する情報： [!DNL Adobe Target] カスタムコードで使用するエクスペリエンステンプレート。 [!DNL Target] エクスペリエンステンプレートは、マーケティング担当者向けの一般的な使用例を実行するための設定可能な入力を備えたコーディング済みのサンプルです。
...
![exp-template-banner-carousel-thumbnails の画像](assets/exp-template-banner-carousel-thumbnails.png)
...
![exp-template-button-builder イメージ](assets/exp-template-button-builder.png)
...
![exp-template-lightbox-exit 画像](assets/exp-template-lightbox-exit.png)
...
![exp-template-ribbon イメージ](assets/exp-template-ribbon.png)
