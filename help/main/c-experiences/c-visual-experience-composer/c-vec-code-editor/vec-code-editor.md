...
1. 選択したエクスペリエンスの[!UICONTROL 変更]ページを表示するには、VEC で&#x200B;]**変更**[!UICONTROL &lt;/>アイコンをクリックします。
