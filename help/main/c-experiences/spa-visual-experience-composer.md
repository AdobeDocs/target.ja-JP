...
上記の例を念頭に置いて、at.js 2のSPAに[!UICONTROL Page Delivery]https://experienceleague.adobe.com/developer/ashop-react-demo/at-js/#/[のみを含めるように](https://experienceleague.adobe.com/developer/ashop-react-demo/at-js/#/)設定を設定すると、どうなるか。*x* を使用）
