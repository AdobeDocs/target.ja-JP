...
* **スクロールバーを操作すると、レポートがクラッシュしました。** 「[!UICONTROL Reports]」タブのスクロールバーをクリックすると、ページがクラッシュし、JavaScript エラーが発生しました。
...
* 「[!UICONTROL View in Analytics]」リンクをクリックすると、ユーザーが意図した[!DNL Analytics] ダッシュボードではなくホームページにリダイレクトされる問題を修正しました。（TGT-53092およびTGT-53093）
