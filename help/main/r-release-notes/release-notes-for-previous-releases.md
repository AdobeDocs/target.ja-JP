...
このアップデートにより、設定の一貫性が確保され、マルチサンドボックス環境での競合を防ぐことができます。 詳しくは、[Adobe Target Destinations](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection){target=_blank} ガイドの&#x200B;*Experience Platform connection*&#x200B;を参照してください。
