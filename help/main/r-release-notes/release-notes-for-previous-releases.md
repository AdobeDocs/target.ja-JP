...
| 機能 | 詳細 |
| --- | --- |
| ![Premium バッジ](/help/main/assets/premium.png)自動ターゲットアクティビティに対する Analytics for Target（A4T）のサポート | [!UICONTROL Auto-Target]のアクティビティで、Target[&#128279;](/help/main/c-integrating-target-with-mac/a4t/a4t.md)の[Analyticsがサポートされるようになりました。<br>この統合により、[!UICONTROL Auto-Target]のアンサンブルマシンラーニングアルゴリズムを使用して、訪問者のプロファイル、行動、コンテキストに基づいて、各訪問者に最適なエクスペリエンスを選択できます。<br>A/B テストおよびエクスペリエンスのターゲット設定アクティビティで使用するA4T](/help/main/c-integrating-target-with-mac/a4t/a4timplementation.md)を既に実装している場合、設定は完了です！<br>詳細については、「[自動配分と自動ターゲット アクティビティのA4T サポート &#x200B;](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md)」を参照してください。 |
...
| 機能／拡張機能 | 説明 |
| --- | --- |
| Analytics for Target（A4T）での [!UICONTROL Auto-Allocate] アクティビティのサポート | [!UICONTROL Auto-Allocate]のアクティビティで、Target[&#128279;](/help/main/c-integrating-target-with-mac/a4t/a4t.md)の[Analyticsがサポートされるようになりました。<br>この統合により、[!UICONTROL Auto-Allocate] マルチアームドバンディット機能を使用して、目標指標[!UICONTROL Adobe Analytics]および/または[!UICONTROL Adobe Analytics]のレポートおよび分析機能を使用しながら、勝者エクスペリエンスへのトラフィックを促進できます。<br>A/B テストおよびエクスペリエンスのターゲット設定アクティビティで使用するA4T](/help/main/c-integrating-target-with-mac/a4t/a4timplementation.md)を既に実装している場合、設定は完了です！<br>詳細については、「[自動配分と自動ターゲット アクティビティのA4T サポート &#x200B;](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md)」を参照してください。 |
