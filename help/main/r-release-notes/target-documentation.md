...
| [Adobe Experience League Target コミュニティ ](https://experienceleaguecommunities.adobe.com/t5/adobe-target/ct-p/adobe-target-community) | [!DNL Target] が提供する機能の詳細、同業者や [!DNL Adobe] の専門家とつながる機能、今後の [!DNL Target] のリリースに向けて投票または自分自身のアイデアを送信する機能について説明します。 |
