...
|  | [&#128279;](https://experienceleague.corp.adobe.com/docs/target-dev/developer/api/delivery-api/overview.html){target=_blank} 開発者ガイドの Delivery API の概要 *[!DNL Target]* | 重要なメモを追加しました。 |
