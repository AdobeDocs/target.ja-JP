...
|  | [ 開発者ガイドの ](https://experienceleague.adobe.com/en/docs/target-dev/developer/api/delivery-api/known-limitations){target=_blank} 考慮事項と既知の制限事項 *[!DNL Target]* | [!DNL Recommendations] を使用して [!UICONTROL Catalogs] [!DNL Target Delivery API] を更新する場合の注意の使用に関する情報を追加しました。 |
