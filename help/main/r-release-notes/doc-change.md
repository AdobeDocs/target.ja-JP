...
| 日付 | トピック | 変更点 |
|--- |--- |--- |
| 9月19日（PT） | [ 宛先ガイドの ](https://experienceleague.adobe.com/ja/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection){target=_blank}0&rbrace;Adobe Target接続 &rbrace; を参照してください。[!DNL Adobe Experience] | *組織全体でのデータストリームの一意性* のメモを更新しました。 |
