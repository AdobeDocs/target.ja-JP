...
| 日付 | トピック | 変更点 |
|--- |--- |--- |
| 8月4日（PT） | [[!DNL Target] UI の更新に関する FAQ](/help/main/c-intro/updated-ui-faq.md#options) | 次の FAQ を追加しました。「更新された VEC で並べ替え、サイズ変更、移動、非表示、削除のオプションを処理する方法と、これらのオプションが従来の VEC とどのように異なりますか？」 |
