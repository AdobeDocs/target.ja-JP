...
| 日付 | トピック | 変更点 |
|--- |--- |--- |
| 8月18日（PT） | [Target 開発者ガイドの ](https://experienceleague.adobe.com/en/docs/target-dev/developer/server-side/integration/a4t-reporting){target=_blank}Analytics for Target （A4T）レポート ** | 以下の節を更新しました。<ul><li>GET リクエストコードスニペットを更新しました。</li><li>クエリ文字列パラメーターと変数の表を更新しました。</li><li>*サンプル A4T データ挿入 HTTP Get 呼び出し* の節を更新しました。</li></ul> |
