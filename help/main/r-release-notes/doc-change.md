...
| 日付 | トピック | 変更点 |
|--- |--- |--- |
| 8月27日（PT） | [[!DNL Target] リリースノート（プレリリース）](/help/main/r-release-notes/target-release-notes.md) | [!DNL Target] 25.8.4 リリース（2025 年 8 月 28 日（PT））のプレリリースノートを更新しました。 リリース日、機能などの情報は、予告なく変更されることがあります。この記事の情報は、特にリリース前に頻繁に更新されます。 |
|  | Visual Experience Composer で使用される要素セレクター | 「[!UICONTROL Use preferred selectors]」オプションを追加しました。 |
