...
| 日付 | トピック | 変更点 |
|--- |--- |--- |
| 11月20日（PT） | [Recommendations アクティビティの作成](/help/main/c-recommendations/t-create-recs-activity/create-recs-activity.md) | 手順 5 に次のメモを追加しました。 <ul><li>[!UICONTROL Recommendations] アクティビティでは、一度に 1 つの変更/レコメンデーションのみをサポートします。 複数のレコメンデーションについては、複数の [!DNL Recommendations] アクティビティを作成するか、A/B または XT テストを使用できます。</li></ul> |
