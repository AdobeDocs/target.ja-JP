...
description: Adobe Experience Cloudから [!DNL Target] にアクセスし、デフォルトの組織を設定し、 [!DNL Target] UIとドキュメントの言語を変更する方法について説明します。
...
## Adobe [!DNL Target]にログインして、既定の組織を設定します。

1. [Adobe Experience Cloud](https://experience.adobe.com/) に新規登録します。

1. ナビゲーションバーの&#x200B;**[!UICONTROL App icon]**&#x200B;をクリックし、**[!UICONTROL Target]**&#x200B;をクリックします。
...
1. （オプション） [!DNL Experience Cloud]にログインするときにデフォルトの組織を設定するには、プロファイルアバターの下の「**[!UICONTROL Preferences]**」をクリックし、デフォルトの組織を設定します。

   ![ランディングページ](/help/main/c-intro/assets/pagepref-new.png)

## [!DNL Target] UIの既定の言語を変更する {#language}

1. [!DNL Adobe Experience Cloud]または[!DNL Target]にログインしたら、プロファイルアバターをクリックし、**[!UICONTROL Preferences]**&#x200B;をクリックします。

1. 「**[!UICONTROL Adobe Account]**」をクリックして、[!DNL Adobe] プロファイルにアクセスします。

   ![アドビアカウント](/help/main/c-intro/assets/adobe-account.png)

1. [!UICONTROL Account] ページの&#x200B;**[!UICONTROL Preferred languages]** セクション、**[!UICONTROL Add]**。
...
## [!DNL Target]製品ドキュメントの言語を変更する {#doc-lang}

お使いのオペレーティングシステムやブラウザーの設定で、優先言語を検出し、その言語のドキュメント（使用できる場合）を表示する必要があります。 [!DNL Target]件のドキュメントは自動的に翻訳され、英語ドキュメントに変更が加えられてから数時間以内に英語版と同期されます。

ページヘッダーの右上にあるグローブアイコン（![言語切り替え](/help/main/assets/icons/GlobeGrid.svg)）をクリックすると、サポートされている任意の言語にすばやく変更できます。
