...
[Adobe Target アクティビティプランナー ](/help/main/assets/activity-planner.pdf) は、保存して何度も繰り返し使用できるスタンドアロン PDFとして含まれています。 PDF ファイルへのリンクをクリックして表示します。右クリックして PDF ファイルをダウンロードします。
