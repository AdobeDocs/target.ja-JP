...
**更新された[!DNL Target] UIと[!UICONTROL Visual Experience Composer] （VEC）に関する情報はどこで確認できますか？**
...
+++詳細を見る
[!DNL Target]には、[!UICONTROL 指標の依存関係]機能を使用して、これを実現するための堅牢な方法があります。 [他の成功指標の依存関係](/help/main/c-activities/r-success-metrics/success-metrics.md#section_7CE95A2FA8F5438E936C365A6D43BC5B)を追加するだけです。 「到達」、「未到達」などのオプションを利用したり、様々な方法で指標を結合し、あらゆる組み合わせを作成したりできます。
...
+++詳細を見る
可能です。 [手順](/help/main/c-activities/edit-activity.md#concept_BB064C0D4A194BD1A1AE7CCA1E6BB8F0)を終了することなく、[!UICONTROL 保存] オプションを使用して段階的な変更を行うことができます。
...
* カスタムは 0 ～ 999 の範囲。 カスタムの場合は、[!UICONTROL きめ細かい優先度]機能（[!UICONTROL 管理] > [!UICONTROL Visual Experience Composer]）を有効にします。
...
**特定のURLを持っていない[!UICONTROL Visual Experience Composer] （VEC）内のログインページを通り過ぎたり、その中に埋め込まれたページに移動したりできないのはなぜですか？**
