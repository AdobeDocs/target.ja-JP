...
1. 必要に応じて、**[!UICONTROL ビジュアル（デフォルト）]**&#x200B;を選択します。
   ...
   フォームベースの Experience Composer を使用する場合は、「[!UICONTROL フォーム]」を選択します。 詳しくは、[フォームベースの Experience Composer](/help/main/c-experiences/form-experience-composer.md) を参照してください。
...
1. アクティビティ URLを指定し、**[!UICONTROL 次へ]**&#x200B;をクリックします。
