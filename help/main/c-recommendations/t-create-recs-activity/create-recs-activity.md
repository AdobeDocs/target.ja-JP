...
1. アクティビティ URLを指定し、**[!UICONTROL Create]**&#x200B;をクリックします。
   ...
   [!UICONTROL Create]をクリックすると、VECが開き、ページが表示されます。 現在の要素をレコメンデーションで置き換えたり、レコメンデーションを挿入したりすることができます。
...
1. ページ上の要素をクリックし、その要素が配置されている場所でレコメンデーションが利用できる場合は、**[!UICONTROL Replace w/ Recommendations]**、**[!UICONTROL Insert Recommendations Before]**、または&#x200B;**[!UICONTROL Insert Recommendations After]**&#x200B;をクリックします。
   ...
   >[!NOTE]
   >
   >[!UICONTROL Recommendations]件のアクティビティでは、一度に1件の変更/レコメンデーションのみがサポートされます。 複数のレコメンデーションの場合は、複数の[!DNL Recommendations] アクティビティを作成するか、A/B テストまたはXT テストを使用できます。
