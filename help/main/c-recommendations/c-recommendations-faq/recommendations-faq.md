...
## [!UICONTROL Recommendations]のアクティビティ、オファー、プロモーション、または条件設定の設定を変更して、サイトに反映するのにどのくらいの時間がかかりますか？
...
次のリストには、特殊なケースが含まれており、[!DNL Target]には[!UICONTROL 互換性] チェックボックスが表示されません。
