...
## 条件および販促へのフィルタ・ルールの追加 {#section_CD0D74B8D3BE4A75A78C36CF24A8C57F}

* **条件**: [ 条件の作成 ](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#task_8A9CB465F28D44899F69F38AD27352FE) 中に、「**[!UICONTROL Inclusion Rules]**」の下の「**[!UICONTROL Add Filtering Rule]**」をクリックします。

  利用できるオプションは、選択した業種とレコメンデーションキーによって変わります。

* **プロモーション**: [ プロモーションの作成 ](/help/main/c-recommendations/t-create-recs-activity/adding-promotions.md#task_CC5BD28C364742218C1ACAF0D45E0E14) 中に、「**[!UICONTROL Promote by Attribute]**」を選択し、「**[!UICONTROL Add Filtering Rule]**」をクリックします。
