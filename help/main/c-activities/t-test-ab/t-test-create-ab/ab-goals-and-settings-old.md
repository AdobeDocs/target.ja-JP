...
description: '[!UICONTROL Goals and Settings] ページを使用して、A/B アクティビティの目標に関する情報を指定する方法を説明します。'
...
[!UICONTROL Goals & Settings] の [!DNL Adobe Target] ページでは、アクティビティの目標に関する情報を指定します。
...
[!UICONTROL Activity Settings] ページの「[!UICONTROL Goals & Settings]」セクションでは、次のオプションを設定できます。
...
[!UICONTROL Advanced Settings] ページの「[!UICONTROL Goals & Settings]」セクションでは、次のオプションを設定できます。
...
[!UICONTROL Other Metadata] ページの [!UICONTROL Goals & Settings] セクションでは、自分自身や他のチームメンバーが手元に置いておくと便利な、アクティビティに関する情報を指定できます。 ノート ペインはサイズ変更が可能です。|
...
このビデオでは、アクティビティを作成する際に 3 ステップのガイドによるワークフロー内でどのようにアクティビティ設定がなされるのか示します。目標と設定については 5:30 から説明します。
