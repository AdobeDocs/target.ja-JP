...
1. （条件付き）エクスペリエンスを管理 ダイアログボックスで、除外するエクスペリエンスの横にある&#x200B;**[!UICONTROL 詳細アクション]** アイコン （![詳細アクション アイコン &#x200B;](/help/main/assets/icons/MoreSmallList.svg)）をクリックし、**[!UICONTROL 除外]**&#x200B;をクリックします。
