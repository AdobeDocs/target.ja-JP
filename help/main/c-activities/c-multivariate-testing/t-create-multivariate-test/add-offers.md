...
1. ページ上のHTML オファーをクリックし、**[!UICONTROL Change HTML Offer]**&#x200B;をクリックします。

1. **[!UICONTROL Create Offer]**&#x200B;をクリックし、**[!UICONTROL HTML Offer]**&#x200B;をクリックしてオファーに名前を付け、HTML オファーのコードを入力または貼り付け、**[!UICONTROL Create]**&#x200B;をクリックします。
