...
1. [[!DNL Analytics Workspace]](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html){target=_blank} レポートに **[!UICONTROL Activity Impressions]** 列を追加します。
