...
## 訪問のスパイクがあります。 これらの訪問が部分的なデータヒットによって引き起こされているかどうかを確認するにはどうすればよいですか？ {#section_28506672C6224ED18AC74F6A02F6F811}
...
## 部分的なデータ ヒットを引き起こす可能性が高い特定のタイプの[!DNL Target] アクティビティはありますか？ {#section_69837442A9B84366BEFDA4588B31E574}
