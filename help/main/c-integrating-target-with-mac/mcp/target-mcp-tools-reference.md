...
+++エクスペリエンスのターゲット設定アクティビティの更新

**ツール：** `update_xt_activity`
...
+++Automated Personalization アクティビティの更新

**ツール：** `update_abt_activity`
...
| オーディエンス | 3 | `list_target_audiences`, `get_target_audience`, `create_target_audience` |
