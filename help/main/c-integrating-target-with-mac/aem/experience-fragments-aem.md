...
* **AEM as a Cloud Service**: [6}Experience Managerのas a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/integrations/experience-fragments-target.html?lang=ja){target=_blank} ガイドの {Adobe Targetへの [!UICONTROL Experience Fragments] の書き出し *。*
