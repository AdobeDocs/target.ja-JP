...
**最終更新日：2025年5月16日（PT）（[変更点を確認](r-release-notes/doc-change.md)）**
...
- [Adobe Target開発者ガイド ](https://experienceleague.adobe.com/docs/target-dev/developer/overview.html?lang=ja){target=_blank}：このポータルでは、[!DNL Target] を実装するための API およびSDKのドキュメントなど、[!DNL Adobe Target] 開発者向けのリソースやガイドを掲載しています。
