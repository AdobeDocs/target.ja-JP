...
**最終更新日：2026年5月12日（[変更内容を見る](r-release-notes/doc-change.md)）**
...
[!DNL Adobe Target]は、Claude、Cursor、ChatGPTなど、MCP互換アプリケーション内で実験、パーソナライゼーション、およびレポート操作を直接表示するMCP （Model Context Protocol） サーバーを提供するようになりました。

[![詳細情報のアイコン &#x200B;](/help/main/assets/learn-more.svg)](/help/main/c-integrating-target-with-mac/mcp/target-mcp.md)

>[!TAB 更新されたターゲット UI]

**簡単に[!DNL Target]を探索**

UIは明瞭性と効率性を考慮して設計されており、[!DNL Target]を最大限に活用できます。 詳細な記事やステップバイステップの説明への直接リンクなど、迅速な対応に役立つリソースをご確認ください。

[![詳細情報のアイコン &#x200B;](/help/main/assets/learn-more.svg)](/help/main/c-intro/understand-the-target-ui.md)

*[!DNL *Targe]t UIの更新に関するFAQ**

このFAQでは、ナビゲーションの変更、機能の場所、一時的なUI バージョンの廃止トグルなど、新しい[!DNL Target] UIと[!UICONTROL Visual Experience Composer] （VEC）に関する一般的な質問に対応しています。 マーケター、開発者、管理者のいずれであっても、この FAQ はスムーズに移行し、更新された UI を最大限に活用するのに役立ちます。
...
**包括的な[!DNL Target] リソース**

複数の形式の[!DNL Target] ドキュメント：ステップバイステップ UI ガイド、開発者リソース（SDKとAPIを含む）、チュートリアル、ビデオ、ウェビナー、活気のあるコミュニティフォーラム。

[![詳細情報のアイコン &#x200B;](/help/main/assets/learn-more.svg)](/help/main/r-release-notes/target-documentation.md)
...
- A[!DNL dobe Experience Platform]の[[!UICONTROL AI Assistant]概要](/help/main/c-intro/ai-assistant.md): [!DNL AI Assistant]は、[!DNL Adobe Target]の概念を操作して理解するために使用できるユーザーインターフェイス機能です。
- [!DNL Target]を[!DNL Adobe Experience Cloud]と統合：[!DNL Target]を[[!UICONTROL Analytics for Target]](/help/main/c-integrating-target-with-mac/a4t/a4t.md) （A4T）、[[!DNL Experience Cloud Audiences]](/help/main/c-integrating-target-with-mac/mmp.md)、[[!DNL Adobe Campaign]](/help/main/c-integrating-target-with-mac/campaign-and-target.md)など、他の[!DNL Experience Cloud] ソリューションと統合する方法について説明します。
...
- [[!DNL Target]  モバイルアプリの場合](https://experienceleague.adobe.com/docs/target-dev/developer/mobile-apps/overview.html?lang=ja){target=_blank}: [!DNL Target]をモバイルアプリの最適化とパーソナライゼーションに使用する方法を説明します。
- [リソースと連絡先情報](cmp-resources-and-contact-information.md)： [!DNL Target] の機能を学ぶ際に役立つ追加の資料や、[!DNL Adobe] への問い合わせ方法についての情報を提供します。

## マーケター {#marketers}

- [[!UICONTROL Activities]](c-activities/activities.md): [!DNL Target] アクティビティのセットアップ、管理、およびQA方法について説明します。
- [[!UICONTROL Audiences]](c-target/target.md): ターゲットアクティビティでコンテンツとエクスペリエンスを誰が見るかを決定する方法について説明します。
- [エクスペリエンスとオファー](c-experiences/experiences.md)：訪問者がアクティビティのオーディエンス条件を満たすときに表示できるコンテンツの指定方法について説明します。
- [[!DNL Recommendations]](c-recommendations/recommendations.md): [!DNL Recommendations]のアクティビティが、以前のユーザーのアクティビティやその他のアルゴリズムに基づいて、顧客が興味を持つ可能性のある製品またはコンテンツを自動的に表示する方法について説明します。

## 開発者 {#developers}

- [[!UICONTROL Adobe Target Developer Guide]](https://experienceleague.adobe.com/docs/target-dev/developer/overview.html?lang=ja){target=_blank}：このガイドでは、[!DNL Target]を実装するためのAPIおよびSDK ドキュメントなど、[!DNL Adobe Target]の開発者向けのリソースとガイドを提供します。

## [!DNL Target]さんと[!DNL Adobe Experience Cloud]人の管理者 {#admins}

- [管理者 [!DNL Target]](administrating-target/administrating-target.md): ユーザーを追加し、[!DNL Target] アカウントを設定する方法について説明します。

## アナリスト {#analysts}

- [[!UICONTROL Audiences]](c-target/target.md): ターゲットアクティビティでコンテンツとエクスペリエンスを誰が見るかを決定する方法について説明します。
- [[!UICONTROL Reports]](c-reports/reports.md): アクティビティのパフォーマンスを解釈する方法を説明します。
