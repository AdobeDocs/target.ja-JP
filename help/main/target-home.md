---
keywords: Target；ホーム；人気の高いトピック；adobe target;target standard;target premium;target ドキュメント；adobe target ドキュメント；home
...
**最終更新日：2022 年 5 月 10 日（PT）（[変更点を参照](r-release-notes/doc-change.md)）**
