---
keywords: Target；ホーム；人気の高いトピック；adobe target;target standard;target premium;target ドキュメント；adobe target ドキュメント
...
**最終更新日：2023年2月23日（PT）（[変更点を参照](r-release-notes/doc-change.md)）**
