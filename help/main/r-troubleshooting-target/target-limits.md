...
description: アクティビティや、 [!DNL Adobe Target].
...
* **制限**:50 mbox/個 [!DNL Target] コンテンツ配信のバッチ mbox リクエスト。
...
* **推奨制限**:1 件につき 50 件の通知 [!DNL Target] 配信バッチリクエスト。

   一件につき五十件を超える通知 [!DNL Target] 配信バッチリクエストを実行すると、応答の遅延とタイムアウトが増加する可能性があります。
